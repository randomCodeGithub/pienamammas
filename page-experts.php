...
/**
 * Template Name: Ekspertu viedoklļis
 */
?>
...
<section class="expert-opinion-page">
    <div class="container">
        ...
        $expert = new WP_Query($args); ?>
        <?php if ($expert->have_posts()) :  ?>
            <div class="row">
                <?php while ($expert->have_posts()) :
                    $expert->the_post();
                ?>
...
<section class="expert-opinion-more">
    <div class="container">
        ...
        <?php if ($experts->have_posts()) :  ?>
            ...
            <div class="row">
                <!-- <a href="#" class="pm-btn pm-btn__blue mx-auto">Ielādēt vēl</a> -->
