		...
		while( $messages->have_messages() ) {
			...
			if ( $i === 1 ) {
				...
				<div class="fep-per-message fep-per-message-top fep-per-message-<?php echo fep_get_the_id(); ?>">
					...
					<div class="fep-message-title-heading participants"><?php esc_html_e( 'Dalībnieks', 'front-end-pm' ); ?>: <?php
					...
					<div class="fep-align-right">
						<button class="fep-button fep-message-toggle-all"><?php esc_html_e( 'Pārslēgt ziņojumus', 'front-end-pm' ); ?></button>
					</div>
					<?php } ?>
				</div>
				<?php
