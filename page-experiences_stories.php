...
/**
 * Template Name: Pieredzes stāsti
 */
?>
...
<section class="experience-stories-page">
    <div class="container">
        ...
        $experience_story = new WP_Query($args); ?>
        <?php if ($experience_story->have_posts()) :  ?>
            <div class="row">
                <?php while ($experience_story->have_posts()) :
                    $experience_story->the_post();
                ?>
                    <div class="col-lg-4">
                        <div class="person">
...
<section class="experience-stories">
    <div class="container">
      ...
      "></div>
            ...
            <div class="row">
                <!-- <a href="#" class="pm-btn pm-btn__red mx-auto">Ielādēt vēl</a> -->
